...
export function overrideAlert() {
    ...
    (window as any).alert = async (message: any, _default: any) => {
...
export function overridePrompt() {
    ...
    (window as any).prompt = async (message: any, _default: any) => {
        messageEl.innerHTML = message;
    ...
    const promiseList: { resolve: (message: string | null) => void }[] = [];
